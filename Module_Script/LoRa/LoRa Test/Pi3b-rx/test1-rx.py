...
<<<<<<< HEAD
lora = LoRa(1, 25, 10, modem_config=ModemConfig.Bw125Cr45Sf128, tx_power=14, acks=True)
=======
lora = LoRa(1, 25, 10, modem_config=ModemConfig.Bw125Cr45Sf128, tx_power=14, acks=False)
>>>>>>> df550321d7536405a7c8f24ef1e4d286ab201e3e
lora.on_recv = on_recv

lora.set_mode_rx() # Turn on the "recivier mode (rx)"

# Testing to print recivied packages
while True:
    try:
        print(lora.on_recv)
    except:
