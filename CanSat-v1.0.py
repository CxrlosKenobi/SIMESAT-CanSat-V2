...
Clases para cada componente.
 ...
 Calcular presión aerodinámica contra el tiempo
 Gráfico de la máxima Velocidad contra en el tiempo
 Gráfico de Aceleración contra el tiempo
 Incoporar codigo para incoporar coordenadas de NEO_6M en un mapa
    - Incoporar mapa con union de puntos
...
'''
- Hallar alternativas u otros codigos paralelos a los que ya tenemos para cada componente
- El esquemático unificador
- Practicar con manejo de pines en Raspberry Pi con Python
- Ver posiblidad de programar una GoPro chinita (enviar media a nosotros, mediante LoRa)
'''
...
print "Pressure : %.2f hPa " %pressure_ADDRESS_68, # In 0x68 Address
